    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 border-t border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-6 md:px-12 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          {/* Copyright */}
          <p className="text-white/20 text-xs tracking-wider order-last md:order-first">
          ...
          <div className="flex items-center gap-6">
            {/* Instagram */}
            <a
              href="https://instagram.com/cosmiclabsindia"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram"
              className="flex items-center gap-1.5 text-white/25 hover:text-white/70 transition-colors duration-300 group"
            >
              ...
              <span className="text-xs tracking-wide hidden sm:inline">cosmiclabsindia</span>
            </a>

            {/* WhatsApp */}
            <a
              href="https://wa.me/918309030927"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="flex items-center gap-1.5 text-white/25 hover:text-white/70 transition-colors duration-300"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>
              </svg>
              <span className="text-xs tracking-wide hidden sm:inline">+91 83090 30927</span>
            </a>

            {/* Email */}
            <a
              href="mailto:cosmiclabsindia@gmail.com"
              aria-label="Email"
              className="flex items-center gap-1.5 text-white/25 hover:text-white/70 transition-colors duration-300"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span className="text-xs tracking-wide hidden sm:inline">cosmiclabsindia@gmail.com</span>
            </a>
          </div>
